...
export const LogoIcon: React.FC<IconProps> = ({ className = "h-8 w-8 text-indigo-600" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" /><path d="M16 3.09c.87 0 1.69.26 2.4.7" /><path d="M12 15.68V21.5" /><path d="M8 12.68V18.5" /></svg>
);

export const IssueTokenIcon: React.FC<IconProps> = ({ className = "h-5 w-5 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
);

export const ReportsIcon: React.FC<IconProps> = ({ className = "h-5 w-5 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 3v18h18" /><path d="M7 12v5h12V8H7z" /><path d="M11 12v5" /><path d="M15 12v5" /><path d="M7 12V8" /></svg>
);

export const PaymentsIcon: React.FC<IconProps> = ({ className = "h-5 w-5 mr-2" }) => (
...
export const SettingsIcon: React.FC<IconProps> = ({ className = "h-5 w-5 mr-2" }) => (
...
export const TrashIcon: React.FC<IconProps> = ({ className = "h-4 w-4 text-red-500" }) => (
